        ...
        <div className="space-y-4 animate-fade-in">
          ...
          <div className="flex flex-wrap items-center justify-between gap-3 p-3.5 rounded-2xl bg-white dark:bg-[#141622] border border-zinc-200 dark:border-[#2A2E45] shadow-xs">
            ...
            <div className="flex items-center gap-2 text-xs font-bold text-zinc-700 dark:text-zinc-300">
              ...
              <span>
                Page <span className="text-blue-600 font-black">{currentPage}</span> of {numPages}
              </span>
              <button
            ...
            <div className="flex items-center gap-2">
              ...
              <button
                ...
                className="px-5 py-2.5 rounded-xl bg-blue-600 hover:bg-blue-700 text-white text-xs font-black shadow-md shadow-blue-600/25 transition-all flex items-center gap-2 cursor-pointer"
              >
                <span>Sign PDF</span>
                  ...
                  return (
                    <div
                      ...
                      className={`absolute group cursor-move select-none p-1 rounded transition-shadow ${
                        isSelected
                          ? 'border-2 border-dashed border-blue-500 ring-2 ring-blue-500/30 bg-white/40 shadow-lg z-20'
                          : 'border border-transparent hover:border-blue-400/80 z-10'
                      }`}
                      style={{
                        left: `${elem.x * zoom}px`,
                        top: `${elem.y * zoom}px`,
              ...
              <div className="p-4 sm:p-5 rounded-3xl bg-white dark:bg-[#141622] border border-zinc-200 dark:border-[#2A2E45] shadow-sm space-y-4">
                ...
                <div className="grid grid-cols-2 gap-2">
                  <button
                    ...
                    className="p-2.5 rounded-xl border border-zinc-200 dark:border-[#2A2E45] bg-zinc-50 hover:bg-blue-50 text-zinc-800 hover:text-blue-600 dark:bg-[#1B1E2E] dark:hover:bg-blue-950/40 text-xs font-bold transition-colors flex items-center gap-2 cursor-pointer"
                  >
                    ...
                    <div className="grid grid-cols-2 gap-2">
                      {savedSignatures.map(sig => (
                        <div
                          ...
                          className="p-2 rounded-xl border border-zinc-200 dark:border-[#2A2E45] bg-white dark:bg-[#1B1E2E] hover:border-blue-500 cursor-pointer shadow-2xs group flex items-center justify-center h-14"
                        >
          ...
          <div className="bg-white dark:bg-[#141622] border border-zinc-200 dark:border-[#2A2E45] rounded-3xl w-full max-w-lg overflow-hidden shadow-2xl space-y-4 p-6">
              ...
              {['signature', 'initials', 'text', 'date', 'checkmark'].map(t => (
                <button
                  ...
                  className={`py-1.5 rounded-lg capitalize transition-colors cursor-pointer ${
                    modalTab === t ? 'bg-white dark:bg-[#2A2E45] text-blue-600 shadow-xs' : 'text-zinc-500'
                  }`}
                >
                  {t}
                </button>
                ...
                <div className="flex items-center justify-center gap-3">
                  <button
                    ...
                    className={`px-4 py-1.5 rounded-xl text-xs font-bold border transition-colors cursor-pointer ${
                      sigMode === 'draw' ? 'bg-blue-50 text-blue-600 border-blue-300 dark:bg-blue-950/40' : 'bg-white dark:bg-[#1B1E2E] border-zinc-200'
                    }`}
                  >
                    ✍️ Draw
                  </button>
                  <button
                    ...
                    className={`px-4 py-1.5 rounded-xl text-xs font-bold border transition-colors cursor-pointer ${
                      sigMode === 'type' ? 'bg-blue-50 text-blue-600 border-blue-300 dark:bg-blue-950/40' : 'bg-white dark:bg-[#1B1E2E] border-zinc-200'
                    }`}
                  >
                    ⌨️ Type (Calligraphy)
                  </button>
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex items-center justify-between">
                        ...
                        {['#000000', '#1E3A8A', '#2563EB'].map(c => (
                          <button
                            ...
                            className={`w-5 h-5 rounded-full border border-white shadow-xs ${
                              penColor === c ? 'ring-2 ring-blue-500 scale-110' : ''
                            }`}
                          />
                        ))}
                      </div>
                      <button
                        ...
                        className="text-xs font-bold text-zinc-500 hover:text-blue-600"
                      >
                        Clear Canvas
                      </button>
                    </div>
                ...
                {sigMode === 'type' && (
                  <div className="space-y-3">
                    <input
                      ...
                      className="w-full text-sm rounded-xl px-3.5 py-2.5 border border-zinc-300 dark:border-[#2A2E45] bg-zinc-50 dark:bg-[#1B1E2E] font-bold text-zinc-900 dark:text-white focus:ring-2 focus:ring-blue-500"
                    />
            ...
            {modalTab === 'checkmark' && (
              <div className="py-6 text-center space-y-2">
                <div className="w-16 h-16 rounded-2xl bg-blue-50 text-blue-600 flex items-center justify-center mx-auto text-3xl font-black">
                  ✓
                </div>
            ...
            <div className="pt-2 flex items-center justify-end gap-2">
              ...
              <button
                ...
                className="px-6 py-2 rounded-xl bg-blue-600 hover:bg-blue-700 text-white text-xs font-bold shadow-md shadow-blue-600/25"
              >
                Place on Document
              </button>
            </div>
