...
export default function SplitPdfTool() {
  ...
  const rangeColorClasses = [
    { border: 'border-red-500 ring-2 ring-red-500/30', badge: 'bg-red-600 text-white', label: 'Range 1' },
              ...
              {pageThumbnails.map((p) => {
                ...
                if (mode === 'extract') {
                  if (isSelectedExtract) {
                    cardBorderClass = 'border-red-500 ring-2 ring-red-500/40 opacity-100 scale-[1.02] shadow-md';
                  } else {
                ...
                return (
                  <div
                    ...
                    className={`group relative rounded-2xl bg-white dark:bg-[#1B1E2E] border p-2.5 flex flex-col items-center justify-between transition-all select-none ${cardBorderClass} ${
                      mode === 'extract' && extractMode === 'select' ? 'cursor-pointer hover:border-red-400' : ''
                    }`}
                  >
                    {/* Page Number Badge */}
                    ...
                    {mode === 'extract' && isSelectedExtract && (
                      <div className="absolute top-2 right-2 z-10 w-5 h-5 rounded-full bg-red-600 text-white flex items-center justify-center shadow-xs">
                  ...
                  {rangeType === 'custom' && (
                    <div className="space-y-3">
                          ...
                          >
                            ...
                            <div className="flex items-center gap-1.5 text-xs font-medium text-zinc-600 dark:text-zinc-400">
                              ...
                              <input
                                ...
                                className="w-14 px-2 py-1 rounded-lg border border-zinc-300 dark:border-[#2A2E45] bg-white dark:bg-[#141622] text-center font-bold text-zinc-900 dark:text-white focus:ring-2 focus:ring-red-500"
                              />
                              <span>to</span>
                              <input
                                type="number"
                      ...
                      <button
                        type="button"
                        onClick={addRange}
                        className="w-full py-2 px-3 rounded-xl border border-dashed border-red-300 dark:border-red-900/60 bg-red-50/50 dark:bg-red-950/20 text-red-600 dark:text-red-400 text-xs font-bold flex items-center justify-center gap-1.5 hover:bg-red-100/50 transition-colors cursor-pointer"
                      >
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <div className="flex items-center gap-2">
                          <input
                            ...
                            className="w-16 px-2 py-1 rounded-lg border border-zinc-300 dark:border-[#2A2E45] bg-white dark:bg-[#141622] text-center font-bold text-zinc-900 dark:text-white focus:ring-2 focus:ring-red-500"
                          />
                    ...
                    <div className="space-y-3">
                      <div className="space-y-1 text-left">
                        ...
                        <input
                          ...
                          className="w-full text-xs rounded-xl px-3 py-2 border border-zinc-300 dark:border-[#2A2E45] bg-white dark:bg-[#141622] font-bold text-zinc-900 dark:text-white focus:ring-2 focus:ring-red-500"
                        />
