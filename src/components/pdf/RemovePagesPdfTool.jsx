              ...
              <div className="flex items-center gap-2">
                ...
                <div className="flex items-center gap-1.5 mr-2">
                  <button
                    ...
                    className="px-2 py-1 rounded-md text-[10px] font-bold bg-zinc-100 hover:bg-red-50 hover:text-red-600 dark:bg-[#1B1E2E] dark:hover:bg-red-950/40 text-zinc-700 dark:text-zinc-300 transition-colors cursor-pointer"
                  >
                    Odd
                  </button>
                  <button
                ...
                <div className="flex items-center gap-0.5 bg-zinc-100 dark:bg-[#1B1E2E] p-0.5 rounded-lg">
                  <button
                    ...
                    className={`px-2 py-1 rounded text-[10px] font-bold transition-colors cursor-pointer ${
                      thumbnailZoom === 'compact' ? 'bg-white dark:bg-[#2A2E45] shadow-xs text-red-600' : 'text-zinc-500'
                    }`}
                  >
                    S
                  </button>
                  <button
                    ...
                    className={`px-2 py-1 rounded text-[10px] font-bold transition-colors cursor-pointer ${
                      thumbnailZoom === 'normal' ? 'bg-white dark:bg-[#2A2E45] shadow-xs text-red-600' : 'text-zinc-500'
                    }`}
                  >
                    M
                  </button>
                  <button
                    ...
                    className={`px-2 py-1 rounded text-[10px] font-bold transition-colors cursor-pointer ${
                      thumbnailZoom === 'large' ? 'bg-white dark:bg-[#2A2E45] shadow-xs text-red-600' : 'text-zinc-500'
                    }`}
                  >
                    L
                  </button>
                ...
                return (
                  <div
                    ...
                    className={`group relative rounded-2xl border p-2.5 flex flex-col items-center justify-between transition-all select-none cursor-pointer ${
                      isMarkedForRemoval
                        ? 'bg-red-50/80 dark:bg-red-950/30 border-red-500 ring-2 ring-red-500/40 opacity-90 scale-[0.98]'
                        : 'bg-white dark:bg-[#1B1E2E] border-zinc-200 dark:border-[#2A2E45] hover:border-red-400 hover:shadow-md'
                    }`}
                  >
                    {/* Page Number Badge */}
                    ...
                    <div className="absolute top-2 right-2 z-10 flex items-center gap-1">
                      {isMarkedForRemoval ? (
                        <div className="px-2 py-0.5 rounded-md bg-red-600 text-white text-[10px] font-black shadow-xs flex items-center gap-1">
                          <Trash2 className="w-3 h-3" />
                          <span>Removed</span>
                        </div>
                      ) : (
                        <div className="w-6 h-6 rounded-full bg-zinc-100 dark:bg-[#141622] group-hover:bg-red-100 dark:group-hover:bg-red-950 text-zinc-400 group-hover:text-red-600 flex items-center justify-center transition-colors shadow-xs">
                    ...
                    <div className="w-full aspect-[3/4] rounded-xl overflow-hidden bg-zinc-50 dark:bg-[#141622] flex items-center justify-center my-1.5 relative border border-zinc-100 dark:border-[#2A2E45]/40">
                      ...
                      {isMarkedForRemoval && (
                        <div className="absolute inset-0 flex items-center justify-center bg-red-500/10 backdrop-blur-[0.5px]">
                          <div className="w-12 h-12 rounded-full bg-red-600 text-white flex items-center justify-center shadow-lg animate-scale-up">
                    ...
                    <span
                      className={`text-[10px] font-bold ${
                        isMarkedForRemoval ? 'text-red-600 dark:text-red-400 line-through' : 'text-zinc-500 dark:text-zinc-400'
                      }`}
                    >
                      Page {p.pageNum}
                    </span>
            ...
            <div className="p-4 sm:p-5 rounded-3xl bg-white dark:bg-[#141622] border border-zinc-200 dark:border-[#2A2E45] shadow-sm space-y-5">
              ...
              <div className="space-y-1.5 text-left">
                ...
                <input
                  ...
                  className="w-full text-xs rounded-xl px-3.5 py-2.5 border border-zinc-300 dark:border-[#2A2E45] bg-zinc-50 dark:bg-[#1B1E2E] font-bold text-zinc-900 dark:text-white focus:ring-2 focus:ring-red-500"
                />
              ...
              <button
                ...
                className="w-full py-4 rounded-2xl bg-red-600 hover:bg-red-700 active:scale-95 disabled:opacity-50 disabled:active:scale-100 text-white font-black text-base shadow-lg shadow-red-600/30 transition-all flex items-center justify-center gap-2 cursor-pointer disabled:cursor-not-allowed"
              >
