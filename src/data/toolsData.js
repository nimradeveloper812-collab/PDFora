...
export const TOOLS = [
  ...
  },
  {
    ...
    "path": "/compress-to-kb",
    "category": "images",
    "shortDesc": "Compress JPG, PNG, SVG or WebP with the best quality and compression.",
    "description": "Compress JPG, PNG, SVG or WebP with the best quality and compression. Reduce the filesize of your images at once.",
    "iconName": "Minimize2",
    "badge": "Popular",
    "acceptedTypes": ".jpg, .jpeg, .png, .webp, .gif, .svg",
    "acceptedFileLabel": "Image files",
    "maxFiles": 20,
    "features": ["Best quality & compression ratio", "Target 100KB, 200KB limits", "Batch multiple images at once", "100% private in-browser"],
    "steps": ["Upload your images.", "Select compression mode.", "Download compressed images."],
    "overview": "Compress images for web, email, and social media with substantial size reduction and zero visible quality loss.",
    "faqs": [{ "q": "Will image quality be preserved?", "a": "Yes, our smart compression reduces file size by up to 80% while retaining crisp visual quality." }],
    "metaTitle": "Compress IMAGE Online — Reduce Image File Size Free | PDFora",
    "metaDescription": "Compress JPG, PNG, SVG or WebP with the best quality and compression. Reduce image file sizes online for free.",
    "h1Title": "Compress IMAGE Online",
    "primaryKeywords": ["compress image", "compress image to kb", "reduce image size free", "image compressor"]
  },
  {
