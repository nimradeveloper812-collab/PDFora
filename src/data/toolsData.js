...
export const TOOLS = [
  ...
  },
  {
    ...
    "category": "pdf",
    "popular": true,
    "shortDesc": "Extract searchable & selectable text from scanned PDF files.",
    "description": "Perform Optical Character Recognition (OCR) on image PDFs to make text searchable and copyable.",
    "iconName": "Sparkles",
    "badge": "Popular",
    "acceptedTypes": ".pdf, application/pdf",
    "acceptedFileLabel": "PDF files",
    "maxFiles": 1,
    "features": ["Recognize text in scanned images", "Convert non-selectable PDF text", "In-browser OCR engine"],
    "steps": ["Upload your scanned PDF document.", "Click \"OCR PDF Now\" to analyze text.", "Download your text-searchable PDF."],
    "overview": "Turn non-selectable scanned PDFs into searchable, indexable digital files.",
    "faqs": [{ "q": "How does OCR PDF work?", "a": "OCR analyzes pixel shapes in scanned pages and overlays searchable text strings." }],
    "metaTitle": "OCR PDF Online Free — Make Scanned PDF Searchable | PDFora",
    "metaDescription": "Perform OCR on scanned PDFs online for free. Convert image PDFs into searchable text privately in your browser.",
    "h1Title": "OCR PDF Online - Make Searchable",
    "primaryKeywords": ["ocr pdf", "pdf ocr online free", "make scanned pdf searchable"]
  },
  {
  ...
  },
  {
    ...
    "category": "pdf",
    "popular": true,
    "shortDesc": "Generate executive summaries and key points from PDFs using AI.",
    "description": "Summarize long research papers, legal contracts, and reports into bullet-point executive summaries.",
    "iconName": "Sparkles",
    "badge": "AI Feature",
    "acceptedTypes": ".pdf, application/pdf",
    "acceptedFileLabel": "PDF files",
    "maxFiles": 1,
    "features": ["Instant executive summary generation", "Extract key bullet points & takeaways", "Save hours reading long documents"],
    "steps": ["Upload your multi-page PDF document.", "Click \"Summarize with AI\".", "Download your summary text report."],
    "overview": "Synthesize 50-page reports into 1-page executive summaries in seconds.",
    "faqs": [{ "q": "How fast is AI Summarization?", "a": "Summaries are generated in under 5 seconds." }],
    "metaTitle": "AI PDF Summarizer Online Free | PDFora",
    "metaDescription": "Summarize long PDF documents online for free using AI. Extract key points and executive summaries instantly.",
    "h1Title": "AI PDF Summarizer Online",
    "primaryKeywords": ["ai pdf summarizer", "summarize pdf free", "ai document summary"]
  },
  {
    "id": "translate-pdf",
    "name": "Translate PDF",
    ...
    "path": "/translate-pdf",
    "category": "pdf",
    "shortDesc": "Translate PDF documents to English, Urdu, Spanish & 50+ languages.",
    "description": "Translate document text between languages while maintaining page formatting.",
    "iconName": "Sparkles",
    "badge": "AI Feature",
    "acceptedTypes": ".pdf, application/pdf",
    "acceptedFileLabel": "PDF files",
    "maxFiles": 1,
    "options": [{ "id": "targetLang", "label": "Target Language", "type": "select", "default": "English", "choices": [{ "value": "English", "label": "English" }, { "value": "Urdu", "label": "Urdu" }, { "value": "Spanish", "label": "Spanish" }, { "value": "Arabic", "label": "Arabic" }] }],
    "features": ["Translate across 50+ languages", "Support for Urdu RTL and multilingual scripts", "Private translation"],
    "steps": ["Upload your PDF document.", "Select your desired target language.", "Click \"Translate PDF Now\"."],
    "overview": "Translate foreign research papers, international invoices, and multi-language manuals.",
    "faqs": [{ "q": "Does it support right-to-left languages like Urdu & Arabic?", "a": "Yes! Full support for RTL typography and character rendering." }],
    "metaTitle": "Translate PDF Online Free — Multilingual PDF Translator | PDFora",
    "metaDescription": "Translate PDF documents to English, Urdu, Spanish, and Arabic online for free. Fast, private translation in your browser.",
    "h1Title": "Translate PDF Documents Online",
    "primaryKeywords": ["translate pdf", "pdf translator free", "translate pdf to urdu"]
  },
  {
    "id": "pdf-to-markdown",
    ...
    "category": "pdf",
    "shortDesc": "Convert PDF documents into clean Markdown (.md) text files.",
    "description": "Extract text, headings, lists, and tables from PDFs into clean Markdown syntax for developers and note-taking apps.",
    "iconName": "Code",
    "badge": "AI Feature",
    "acceptedTypes": ".pdf, application/pdf",
    "acceptedFileLabel": "PDF files",
    "maxFiles": 1,
    "features": ["Convert PDF structure to Markdown (.md)", "Ideal for Obsidian, Notion & GitHub", "Instant conversion"],
    "steps": ["Upload your PDF file.", "Click \"Convert to Markdown\".", "Download your `.md` file."],
    "overview": "Import PDF research and document notes directly into Obsidian, Notion, or static site generators.",
    "faqs": [{ "q": "What format is generated?", "a": "Outputs clean `.md` text files formatted with standard Markdown syntax." }],
    "metaTitle": "PDF to Markdown Converter Online Free | PDFora",
    "metaDescription": "Convert PDF files to clean Markdown (.md) text online for free. Ideal for Notion, Obsidian, and developers.",
    "h1Title": "Convert PDF to Markdown Online",
    "primaryKeywords": ["pdf to markdown", "convert pdf to md free", "pdf to markdown converter"]
  },
  {
    "id": "chat-with-pdf",
    "name": "Chat with PDF",
    ...
    "category": "pdf",
    "popular": true,
    "shortDesc": "Ask questions, extract clauses, and chat interactively with your PDF documents.",
    "description": "Interactive AI assistant sidebar that answers questions, queries payment clauses, and summarizes textbook chapters with page citations.",
    "iconName": "Sparkles",
    "badge": "AI Feature",
    "acceptedTypes": ".pdf, application/pdf",
    "acceptedFileLabel": "PDF files",
    "maxFiles": 1,
    "features": ["Interactive sidebar Q&A chat", "Page reference citations for all answers", "100% private in-browser document processing"],
    "steps": ["Upload your PDF contract, textbook, or report.", "Type any question or click a suggested prompt.", "Receive instant AI answers with page citations."],
    "overview": "Ask questions to long contracts, academic papers, and technical specifications directly inside your web browser.",
    "faqs": [{ "q": "Are my confidential contracts uploaded to external servers?", "a": "No, text parsing and interactive AI Q&A execute privately inside your browser memory." }],
    "metaTitle": "Chat with PDF Online Free — Interactive AI Assistant | PDFora",
    "metaDescription": "Ask questions and chat with your PDF documents online for free. Extract key clauses and receive instant answers with page citations.",
    "h1Title": "Chat with PDF AI Assistant",
    "primaryKeywords": ["chat with pdf", "pdf ai assistant", "ask questions to pdf free"]
  },
  {
  ...
  },
  {
    ...
    "category": "pdf",
    "shortDesc": "Detect data tables in PDFs and export them directly to CSV or Excel.",
    "description": "Automatically extract numeric data grids and financial tables from PDF invoices into CSV or Excel (.xlsx) files.",
    "iconName": "Table",
    "badge": "AI Feature",
    "acceptedTypes": ".pdf, application/pdf",
    "acceptedFileLabel": "PDF files",
    "maxFiles": 1,
    "features": ["Auto-detect table grids and financial rows", "Interactive browser data preview", "1-click export to CSV & Excel (.xlsx)"],
    "steps": ["Upload your PDF invoice or financial report.", "Preview extracted table rows and columns.", "Export to Excel (.xlsx) or CSV with 1 click."],
    "overview": "Stop manually copying numbers from PDF invoices into spreadsheets. Extract structured tables automatically.",
    "faqs": [{ "q": "Does it export formatted Excel sheets?", "a": "Yes, exports directly into native .xlsx workbooks." }],
    "metaTitle": "AI Table Extractor Online Free — PDF to CSV & Excel | PDFora",
    "metaDescription": "Extract tables from PDF files online for free. Auto-detect data grids and export directly to CSV and Excel (.xlsx).",
    "h1Title": "AI Table & Data Extractor from PDF",
    "primaryKeywords": ["ai table extractor pdf", "extract pdf tables to excel", "pdf invoice table converter"]
  },
  {
    ...
    "category": "pdf",
    "shortDesc": "View and edit PDF document properties (Title, Author, Subject, Keywords).",
    "description": "Modify PDF document title, author metadata, subject, keywords, and producer tags.",
    "iconName": "Edit3",
    "badge": "New",
    "acceptedTypes": ".pdf, application/pdf",
    "acceptedFileLabel": "PDF files",
    "maxFiles": 1,
    "features": ["View & edit document title, author & subject", "Embed custom keyword tags", "100% private in-browser metadata saving"],
    "steps": ["Upload your PDF document.", "Modify the metadata fields.", "Click \"Save & Export Metadata PDF\"."],
    "overview": "Edit PDF document properties before publishing research, corporate reports, or legal filings.",
    "faqs": [{ "q": "Does metadata editing alter document text?", "a": "No, it only updates document property headers." }],
    "metaTitle": "PDF Metadata Editor Online Free — Change PDF Properties | PDFora",
    "metaDescription": "View and edit PDF document metadata (Title, Author, Subject, Keywords) online for free. Private, in-browser metadata editing.",
    "h1Title": "PDF Metadata Editor Online",
    "primaryKeywords": ["pdf metadata editor", "edit pdf title author", "pdf properties editor free"]
  },
  {
    "id": "json-to-csv",
